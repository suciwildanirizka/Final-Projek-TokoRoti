...
<div class="col-lg-9 mt-2">
        ...
        <div class="carousel-inner rounded">
            ...
            ?>
                <div class="carousel-item <?php echo $aktif ?>">
                    <img src="assets/img/<?php echo $data['foto'] ?>" class="img-fluid " style="height: 270px; width:1000px; object-fit:cover" alt="...">
    ...
    <div class="card mt-4 border-0 bg-light">
        <div class="card-body text-center">
            <h5 class="card-title"> FAVOROTI - APLIKASI PENJUALAN ROTI DAN KUE </h5>
            <p class="card-text"> Aplikasi penjualan Roti dan Kue yang mudah dan praktis. Nikmati beragam produk Roti dan Kue favorit Anda. 
            </p>
            <a href="order"> <href="order" button class="btn btn-white link-light" style="background-color: #df531c;" data-bs-toggle="modal" data-bs-target="#ModalTambahUser"></href>Buat Order</a>
        </div>
    </div>
    <!-- Akhir Judul -->

    <!-- Chart -->
    <div class="card mt-5 mb-4 border-0 bg-light">
        <div class="card-body text-center">
            <div>
                ...
                new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            borderWidth: 1,
                            backgroundColor: [
                                'rgba(245, 39, 102, 0.88)',
                                'rgba(0, 96, 234, 0.88)',
                                'rgba(234, 255, 93, 0.88)',
                                'rgba(0, 202, 27, 0.88)',
                                'rgba(195, 20, 239, 0.88)',
                                'rgba(246, 150, 52, 0.88)',
                                'rgba(90, 5, 5, 0.8)',
                                'rgba(182, 137, 24, 0.88)',
                                'rgba(111, 112, 20, 0.88)',
                            ],
