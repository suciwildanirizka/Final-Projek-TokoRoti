    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <button class="btn btn-white link-light" style="background-color: #df531c;"  data-bs-toggle="modal" data-bs-target="#ModalTambahUser"> Tambah Kategori Menu </button>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_katmenu.php" method="POST">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-white link-light" style="background-color: #df531c;" name="input_katmenu_validate" value="12345">Save changes</button>
                                </div>
                            </form>
                        </div>
                    </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form class="needs-validation" novalidate action="proses/proses_edit_katmenu.php" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-floating mb-3">
                                        <select class="form-select" aria-label="Defaul select example" required name="jenismenu" id="">
                                                    <?php
                                                    $data = array("Roti", "Kue");
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                    <button type="submit" class="btn btn-success" name="input_katmenu_validate" value="12345">Save changes</button>
                                </div>
                            </form>
                            </div>
                        </div>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        ...
                                        data-bs-target="#ModalDelete<?php echo $row['id_kat_menu'] ?>"><i class="bi bi-trash"></i>
                                        </button>
