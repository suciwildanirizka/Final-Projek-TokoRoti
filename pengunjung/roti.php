...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <h4 class="text-center mb-4"> Aneka Roti</h4>
      ...
      <div class="row">
        <div class="col-md-3 mb-4">
          <div class="card">
            <a href="../pengunjung/assets/img/roti_pita.jpg" data-lightbox="baked-pastry" data-title="baked pastry">
              <img src="../pengunjung/assets/img/roti_pita.jpg" class="card-img-top" alt="">
            </a>
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Roti Pita</strong>
              </h5>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/roti_gandum.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning">
                <strong>Roti Gandum</strong>
              </h5>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/roti_kepang.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Roti Kepang</strong>
              </h5>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/roti_ Croissant.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Roti Croissant</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 15.000</h4>
              <button type="button" class="btn btn-outline-warning w-100" data-bs-toggle="modal" data-bs-target="#DetailModal">
                Detail</button>
            </div>
          </div>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/roti_sobek.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Roti Sobek</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 7.000</h4>
              <button type="button" class="btn btn-outline-warning w-100" data-bs-toggle="modal" data-bs-target="#DetailModal">
                Detail</button>
            </div>
          </div>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/roti_coklat.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Roti Cokelat</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 11.000</h4>
              <button type="button" class="btn btn-outline-warning w-100" data-bs-toggle="modal" data-bs-target="#DetailModal">
                Detail</button>
            </div>
          </div>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/rye.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Roti Rye</strong>
              </h5>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/bagel.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Roti Bagel</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 12.000</h4>
              <button type="button" class="btn btn-outline-warning w-100" data-bs-toggle="modal" data-bs-target="#DetailModal">
                Detail</button>
            </div>
          </div>
        ...
        <div class="modal-body">
          <form>
            <div class="row">
              <div class="col-lg-4">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="Roti Pita">
                  <label for="floatingInput">Nama Menu</label>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="IDR 18.000 Per potongan">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="Roti datar dan bundar dengan isian daging panggang, sayuran segar, keju, dan saus">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" value="Disajikan dengan lipatan sandwich yang dapat dipegang dengan tangan">
        ...
        <div class="modal-body">
          <form>
            <div class="row">
              <div class="col-lg-4">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="Bread Salad">
                  <label for="floatingInput">Nama Menu</label>
                </div>
              </div>
              <div class="col-lg-4">
  ...
  <div class="modal fade" id="DetailModal4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-fullscreen-md-down">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Detail Deskripsi</h1>
