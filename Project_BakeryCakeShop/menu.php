    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <button class="btn btn-white link-light" style="background-color: #df531c;"  data-bs-toggle="modal" data-bs-target="#ModalTambahUser"> Tambah Menu </button>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            ...
                            method="POST" enctype="multipart/form-data">
                                            ...
                                            <option selected hidden value="">Pilih Kategori Menu</option>
                                                <?php
                                                    foreach ($select_kat_menu as $value ){
                                                        echo "<option value=".$value['id_kat_menu'].">
                                                        $value[kategori_menu]</option>";
                                                    }
                                                ?>
                                            </select>
                                            <label for="floatingInput">Kategori Roti atau Kue</label>
                                            <div class="invalid-feedback">
                                                Pilih Kategori Roti atau Kue
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-white link-light" name="input_menu_validate" 
                                    value="12345" style="background-color: #df531c;">Save changes</button>
                                </div>
                            </form>
                        </div>
                    </div>
            ...
            <?php
            if (empty($result)) {
                echo "Data Menu Roti atau Kue tidak ada";
            } else {
                                                ...
                                                <?php
                                                    foreach ($select_kat_menu as $value ){
                                                        if($row['kategori']==$value['id_kat_menu']){
                                                            echo "<option selected value=".$value['id_kat_menu'].">
                                                            $value[kategori_menu]</option>";
                                                        }else{
                                                            echo "<option value=".$value['id_kat_menu'].">
                                                            $value[kategori_menu]</option>";
                        ...
                        <div class="modal-body">
                            ...
                            <input type="hidden" value="<?php echo $row['id']?>" name="id">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-success" name="input_menu_validate" 
                                    value="12345">Save changes</button>
                                </div>
                            </form>
                        </div>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo ( $row['jenis_menu'] == 1) ? "Roti" : "Kue"?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        data-bs-target="#ModalDelete<?php echo $row['id'] ?>"><i class="bi bi-trash"></i>
                                        </button>
                                        </div>
                                    </td>
                                </tr>
