...
<body>
  ...
  <div class="container">
    <div class="row">
      <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../pengunjung/assets/img/iklan2.jpg" class="d-block w-100 img-fluid" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../pengunjung/assets/img/iklan8.jpg" class="d-block w-100 img-fluid" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../pengunjung/assets/img/iklan.jpg" class="d-block w-100 img-fluid" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../pengunjung/assets/img/iklan6.jpg" class="d-block w-100 img-fluid" alt="...">
          </div>
        </div>
      ...
      <h4 class="text-center mb-4"> Aneka Cupcake</h4>
      ...
      <div class="row">
        <div class="col-md-3 mb-4">
          <div class="card">
            <a href="../pengunjung/assets/img/labu.jpg" data-lightbox="baked-pastry" data-title="baked pastry">
              <img src="../pengunjung/assets/img/labu.jpg" class="card-img-top" alt="">
            </a>
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Cupcake Labu</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 3.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/Maple Pecan.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning">
                <strong>Maple Pecan</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 4.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/cc_oreo.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Obsesi Oreo</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 3.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/cc_orange.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Fantasi Wortel</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 2.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/cc_fantasi_rv.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Red Velvet</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 3.500</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/cc_cklt.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Cokelat</strong>
              </h5>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/marshmellow.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Mellow Soft</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 5.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/cc_huzelnut.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Huzelnut</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 3.000</h4>
