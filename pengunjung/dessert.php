...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <h4 class="text-center mb-4"> Aneka Dessert</h4>
      ...
      <div class="row">
        <div class="col-md-3 mb-4">
          <div class="card">
            <a href="../pengunjung/assets/img/d_nutella.jpg" data-lightbox="baked-pastry" data-title="baked pastry">
              <img src="../pengunjung/assets/img/d_nutella.jpg" class="card-img-top" alt="">
            </a>
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Nutella Lumer</strong>
              </h5>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/d_blue.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning">
                <strong>Blueberry Cream</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 9.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/durian.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Durian Delight</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 17.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/dalgona1.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Dalgona</strong>
              </h5>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/oreo.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Cheese Oreo</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 13.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/natulla.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Cotta Strawberry</strong>
              </h5>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/d_tiramisu.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Tiramisu Vanila</strong>
              </h5>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/klepon.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
