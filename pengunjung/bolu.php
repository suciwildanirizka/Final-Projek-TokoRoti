...
<body>
  ...
  <div class="container">
    <div class="row">
      ...
      <h4 class="text-center mb-4"> Aneka Bolu</h4>
      ...
      <div class="row">
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/bolu.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Orange Swit</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 28.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/Bolu fruit.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning">
                <strong>Melt Fruit</strong>
              </h5>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/butter cake.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/b_susu.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Bolu Susu</strong>
              </h5>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/b_kc_ijo.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Kacang Ijo</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 47.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/wortel.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Bolu Wortel</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 51.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/bolu_red.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Bolu Red Velvet</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 93.000</h4>
        ...
        <div class="col-md-3 mb-4">
          <div class="card">
            <img src="../pengunjung/assets/img/b_zebra.jpg" class="card-img-top" alt="">
            <div class="card-body">
              <h5 class="card-title text-center text-warning ">
                <strong>Zebra Vanilla</strong>
              </h5>
              <h4 class="text-center text-dark mb-3">Rp 50.000</h4>
        ...
        <div class="modal-body">
          <form>
            <div class="row">
              <div class="col-lg-4">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="Kacang Ijo">
                  <label for="floatingInput">Nama Menu</label>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="IDR 4.000 Per potongan">
                  <label for="floatingInput">Harga</label>
                </div>
              </div>
              <div class="col-lg-4">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="Dengan rasa kacang ijo yang khas dan dibuat dengan dikukus menambah kenikmatan disetiap gigitan">
                  <label for="floatingPassword">Keterangan</label>
                </div>
              </div>
            </div>
        ...
        <div class="modal-body">
          <form>
            <div class="row">
              <div class="col-lg-4">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="Bolu Wortel">
                  <label for="floatingInput">Nama Menu</label>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="IDR 51.000 Per loyang">
                  <label for="floatingInput">Harga</label>
                </div>
              </div>
              <div class="col-lg-4">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="Bolu dengan varian wortel yang smooth">
                  <label for="floatingPassword">Keterangan</label>
                </div>
              </div>
            </div>
        ...
        <div class="modal-body">
          <form>
            <div class="row">
              <div class="col-lg-4">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="Bolu Red Velvet">
                  <label for="floatingInput">Nama Menu</label>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="IDR 93.000 Per loyang">
                  <label for="floatingInput">Harga</label>
                </div>
              </div>
              <div class="col-lg-4">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="Bolu dengan warna merah menghiasi membuat sangat indah disetiap gigitan, Full rasa ret velvet">
                  <label for="floatingPassword">Keterangan</label>
                </div>
              </div>
            </div>
        ...
        <div class="modal-body">
          <form>
            <div class="row">
              <div class="col-lg-4">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="Zebra Vanilla">
                  <label for="floatingInput">Nama Menu</label>
                </div>
              </div>
              <div class="col-lg-4">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="IDR 50.000 Per loyang">
                  <label for="floatingInput">Harga</label>
                </div>
              </div>
              <div class="col-lg-4">
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-floating mb-3">
                  <input disabled type="text" class="form-control" id="floatingInput" value="Bolu dengan tektur smoothBolu dengan rasa mix coklat dan dibuat dengan dikukus">
                  <label for="floatingPassword">Keterangan</label>
                </div>
              </div>
            </div>
