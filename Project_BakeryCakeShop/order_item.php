                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="form-floating mb-3">
                                            ...
                                            <label for="menu">Menu Roti/Kue</label>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            btn-sm me-1 disabled" : "btn btn-warning btn-sm me-1"; ?>" data-bs-toggle="modal" data-bs-target="#ModalEdit<?php echo $row['id_list_order'] ?>">
                                                <i class="bi bi-pencil-square"></i></button>

                                            <!-- button delete-->
                                            <button class="<?php echo (!empty($row['id_bayar'])) ? "btn btn-secondary 
                                            btn-sm me-1 disabled" : "btn btn-danger btn-sm me-1"; ?>" data-bs-toggle="modal" data-bs-target="#ModalDelete<?php echo $row['id_list_order'] ?>">
