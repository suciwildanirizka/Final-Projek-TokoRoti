        ...
        <div class="card-body">
            <div class="row">
                <div class="col d-flex justify-content-end">
                    <button class="btn btn-white link-light" style="background-color: #df531c;" data-bs-toggle="modal" data-bs-target="#ModalTambahUser"> Tambah User</button>
                </div>
            </div>
                        ...
                        <div class="modal-body">
                            <form class="needs-validation" novalidate action="proses/proses_input_user.php" method="POST">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-floating mb-3">
                                            <select class="form-select" aria-label="Default select example" name="level" required>
                                                ...
                                                <option value="2">Admin</option> <!-- Untuk ADMIN(Tes dulu) di DATABASE nanti ganti 2 lagi -->
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-white link-light" style="background-color: #df531c;" name="input_user_validate" value="12345">Save changes</button>
                                </div>
                            </form>
                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="form-floating mb-3">
                                                <select disabled class="form-select" aria-label="Default select example" required name="level" id="">
                                                    <?php
                                                    $data = array("Owner", "Admin", "Kasir", "Pengunjung");
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form class="needs-validation" novalidate action="proses/proses_delete_user.php" method="POST">
                                    ...
                                    <div class="col-lg-12">
                                        <?php 
                                            if($row['username'] == $_SESSION['username_favoroti']){
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-danger" name="input_user_validate" value="12345" <?php echo ($row['username'] == $_SESSION['username_favoroti']) ? 'disabled' : '' ; ?>>Hapus</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                                ...
                                <form class="needs-validation" novalidate action="proses/proses_reset_password.php" method="POST">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        if ($row['username'] == $_SESSION['username_favoroti']) {
                                            ...
                                            echo "Apakah anda yakin ingin menreset password user <b>$row[username]</b> menjadi password bawaan sistem yaitu <b>password</b>";
                                        }
                                        ?>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                        <button type="submit" class="btn btn-success" name="input_user_validate" value="1234" <?php echo ($row['username'] == $_SESSION['username_favoroti']) ? 'disabled' : ''; ?>>Reset Password</button>
                                    </div>
                                </form>
                            </div>
                        </div>
